...
const Skiper19 = () => {
  ...
  return (
    <section
      ref={ref}
      className="mt-40 relative flex w-fit flex-col items-center justify-center gap-5 text-center"
    >
      <div className="mt-32 relative flex w-fit flex-col items-center justify-center gap-5 text-center">
        <h1 className="font-[poppins] relative z-10 text-7xl font-medium tracking-[-0.08em] lg:text-9xl">
          The Stroke <br /> That follows the <br />
          Scroll Progress
        </h1>
        <p className="font-mono relative z-10 max-w-2xl text-xl font-medium text-[#1F3A4B] dark:text-white">
...
/>
     ...
     <div className="rounded-4xl font-jakarta-sans w-full translate-y-[60vh] pb-10 text-[#FAFDEE]">
         <Preview/>
     </div>
    </section>
  );
