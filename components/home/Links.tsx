...
<span className="text-amber-300">StackLens AI</span>
          ...
          <div className="flex flex-col items-center">
            <section className="grid place-content-center gap-2 px-8 py-10 text-white">
              <div className="group flex items-center justify-center">
                <Icons.linkedin />
                <FlipLink href="https://www.linkedin.com/in/rohan-24may/">Linkedin</FlipLink>
              </div>
              <div className="group flex items-center justify-center">
              ...
              <div className="group flex items-center justify-center">
                <Icons.github />
                <FlipLink href="https://github.com/rohan24may">Github</FlipLink>
              </div>
              <div className="group flex items-center justify-center">
                <FlipLink href="https://www.instagram.com/roha_n_._/">Instagram</FlipLink>
                <Icons.instagram />
              </div>
            </section>
          </div>
