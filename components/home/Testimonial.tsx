...
import { testimonials } from '@/constant/constatnt'
import { useScroll, useTransform, motion } from 'framer-motion'
import { Three3dPng } from '@/public/assets/images/image'
   ...
   <div className='flex flex-col items-center gap-y-5 '>
       <div  className='flex items-center gap-2 rounded-2xl font-mono border px-4 py-1'>
         ...
         <div className='flex flex-col items-center ' >
            <span  className='text-5xl text-center md:text-7xl font-[poppins] font-black'>Loved By <span className='dark:text-amber-200 text-blue-400'>Developer</span></span>
            <p className='text-xs md:text-lg mt-2 font-mono text-center'>See what the community is saying about <span className='text-blue-400'>StackLense-AI.</span></p>
         </div>
